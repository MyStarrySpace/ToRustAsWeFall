...
const DISTRICT_PIECES := {
	"channels": {
		...
		"pieces": {
			...
			"valve_bank": "ValveBank",
			# The wash/ascent props: this district's own dressing, built by its
			# own Blender file rather than borrowed from the archetype set.
			"cage_lamp": "CageLamp",
			"channel_collar": "ChannelCollar",
			"deck_sluice": "DeckSluice",
			"deck_sluice_b": "DeckSluiceB",
			"deck_sluice_c": "DeckSluiceC",
			"drum_crown": "DrumCrown",
			"drum_shell": "DrumShell",
			"pipe_bracket": "PipeBracket",
			"pipe_cross": "PipeCross",
			"pipe_elbow": "PipeElbow",
			"pipe_end": "PipeEnd",
			"pipe_straight": "PipeStraight",
			"pipe_straight_banded": "PipeStraightBanded",
			"pipe_straight_valve": "PipeStraightValve",
			"pipe_tee": "PipeTee",
			"sapscrap_body": "SapscrapBody",
			"water_band_deck": "WaterBandDeck",
			"water_band_deck_b": "WaterBandDeckB",
			"water_band_deck_c": "WaterBandDeckC",
			"water_band_trough": "WaterBandTrough",
			"water_band_trough_b": "WaterBandTroughB",
			"water_band_trough_c": "WaterBandTroughC",
			"water_channel_b": "WaterChannelB",
			"water_channel_c": "WaterChannelC",
			"water_surface": "WaterSurface",
			# ...and the rest of the district's dressing: the overgrowth, the
			# scaffolding kit, the deck and wall tiling, the signage.
			"ball_joint_pipe": "BallJointPipe",
			"biolume_cluster": "BiolumeCluster",
			"broken_pier": "BrokenPier",
			"deck_grate_b": "DeckGrateB",
			"deck_planks": "DeckPlanks",
			"deck_planks_b": "DeckPlanksB",
			"deck_planks_c": "DeckPlanksC",
			"door_ironband": "DoorIronband",
			"gate_sign": "GateSign",
			"pipe_rack": "PipeRack",
			"portal_console": "PortalConsole",
			"porthole": "Porthole",
			"railing_run": "RailingRun",
			"red_bar_lamp": "RedBarLamp",
			"reservoir_platform": "ReservoirPlatform",
			"scaffold_leg": "ScaffoldLeg",
			"scaffold_truss": "ScaffoldTruss",
			"vein_trunk": "VeinTrunk",
			"wall_panel_tile": "WallPanelTile",
			"wall_panel_tile_b": "WallPanelTileB",
			"wall_panel_tile_c": "WallPanelTileC",
			"wall_tracery": "WallTracery",
