...
const BUILDINGS := [
	...
	"facility_checkpoint", "fabrication_hall", "bonded_warehouse", "reclamation_works",
...
const SPECS := {
	...
	# CONNECTIVE INFRASTRUCTURE CATALOG. These four specimens use the same surveyed metre grid as
	# the district heroes, but expose typed service ports as well as doors/roads. The generator can
	# therefore compose a legible material chain instead of scattering industrial-looking props.
	# Dimensions are canonical seed-0 construction drawings; seeded variants scale the entire survey.
	"fabrication_hall": {
		"title": "Fabrication Hall",
		"shape": SHAPE_BOX,
		"size": Vector3(4.2, 5.4, 4.0),
		"construction_module_m": 1.05,
		"bay_count": 4,
		"system_role": "manufacturing",
		"supply_chain_stage": "transform",
		"entrances": {"main_w": 1.35, "main_h": 2.25, "side_count_min": 0, "side_count_max": 0,
			"canopy_out": 0.0, "reserve_margin": 0.20, "main_surround": false},
		"service_ports": [
			{"id": "stock_intake", "commodity": "metal_stock", "flow": "in", "face": "left", "y_frac": 0.24, "lateral": -0.22, "width": 0.42},
			{"id": "power_intake", "commodity": "electricity", "flow": "in", "face": "rear", "y_frac": 0.62, "lateral": -0.28, "width": 0.28},
			{"id": "water_intake", "commodity": "process_water", "flow": "in", "face": "rear", "y_frac": 0.25, "lateral": 0.30, "width": 0.32},
			{"id": "parts_dispatch", "commodity": "fabricated_goods", "flow": "out", "face": "right", "y_frac": 0.34, "lateral": -0.18, "width": 0.46},
			{"id": "effluent_out", "commodity": "wastewater", "flow": "out", "face": "right", "y_frac": 0.17, "lateral": 0.35, "width": 0.26},
		],
		"color": Color(0.31, 0.35, 0.33),
		"tile": "facility_metal", "lattice": "", "pipes": false,
	},
	"bonded_warehouse": {
		"title": "Bonded Warehouse",
		"shape": SHAPE_BOX,
		"size": Vector3(4.4, 6.2, 4.2),
		"construction_module_m": 1.10,
		"bay_count": 4,
		"system_role": "storage",
		"supply_chain_stage": "buffer",
		"entrances": {"main_w": 1.45, "main_h": 2.45, "side_count_min": 0, "side_count_max": 0,
			"canopy_out": 0.0, "reserve_margin": 0.20, "main_surround": false},
		"service_ports": [
			{"id": "goods_receiving", "commodity": "fabricated_goods", "flow": "in", "face": "left", "y_frac": 0.30, "lateral": -0.20, "width": 0.48},
			{"id": "inventory_feed", "commodity": "data", "flow": "in", "face": "rear", "y_frac": 0.66, "lateral": 0.26, "width": 0.24},
			{"id": "freight_dispatch", "commodity": "freight", "flow": "out", "face": "right", "y_frac": 0.30, "lateral": 0.18, "width": 0.50},
		],
		"color": Color(0.29, 0.32, 0.31),
		"tile": "facility_metal", "lattice": "", "pipes": false,
	},
	"reclamation_works": {
		"title": "Reclamation Works",
		"shape": SHAPE_CYLINDER,
		"radius": 2.05, "height": 5.5,
		"construction_module_m": 0.78,
		"bay_count": 8,
		"system_role": "water_waste_utility",
		"supply_chain_stage": "recover",
		"entrances": {"main_w": 1.05, "main_h": 1.90, "side_count_min": 0, "side_count_max": 0,
			"canopy_out": 0.0, "reserve_margin": 0.18, "main_surround": false},
		"service_ports": [
			{"id": "wastewater_intake", "commodity": "wastewater", "flow": "in", "theta_off": 1.18, "y_frac": 0.22, "width": 0.38},
			{"id": "power_intake", "commodity": "electricity", "flow": "in", "theta_off": -2.05, "y_frac": 0.58, "width": 0.24},
			{"id": "water_outfall", "commodity": "process_water", "flow": "out", "theta_off": -1.18, "y_frac": 0.25, "width": 0.40},
		],
		"color": Color(0.23, 0.35, 0.33),
		"tile": "facility_metal", "lattice": "", "pipes": false,
	},
	"distribution_substation": {
		"title": "Distribution Substation",
		"shape": SHAPE_BOX,
		"size": Vector3(4.0, 4.8, 4.0),
		"construction_module_m": 0.80,
		"bay_count": 5,
		"system_role": "power_data_utility",
		"supply_chain_stage": "distribute",
		"entrances": {"main_w": 1.05, "main_h": 2.00, "side_count_min": 0, "side_count_max": 0,
			"canopy_out": 0.0, "reserve_margin": 0.18, "main_surround": false},
		"service_ports": [
			{"id": "grid_intake", "commodity": "grid_power", "flow": "in", "face": "rear", "y_frac": 0.64, "lateral": 0.0, "width": 0.36},
			{"id": "east_feeder", "commodity": "electricity", "flow": "out", "face": "right", "y_frac": 0.52, "lateral": -0.24, "width": 0.30},
			{"id": "west_feeder", "commodity": "electricity", "flow": "out", "face": "left", "y_frac": 0.52, "lateral": 0.24, "width": 0.30},
			{"id": "data_trunk", "commodity": "data", "flow": "out", "face": "right", "y_frac": 0.72, "lateral": 0.30, "width": 0.22},
		],
		"color": Color(0.27, 0.33, 0.34),
		"tile": "facility_metal", "lattice": "", "pipes": false,
	},
	"nutech_facility": {
