...
const MODEL_PATH := "res://resources/models/fauna/ferrule/ferrule.gltf"
const BIN_PATH := "res://resources/models/fauna/ferrule/ferrule.bin"
const BODY_TEXTURE := "res://resources/models/fauna/ferrule/ferrule_body.png"
const MOUTH_TEXTURE := "res://resources/models/fauna/ferrule/ferrule_mouth.png"
const SIGNAL_TEXTURE := "res://resources/models/fauna/ferrule/ferrule_signal.png"
const SIGNAL_EMISSIVE := "res://resources/models/fauna/ferrule/ferrule_signal_emissive.png"
const WRAPPER_PATH := "res://scenes/props/biota/ferrule_visual.tscn"
const MASTER_PATH := "res://../blender/fauna/ferrule/ferrule.blend"
const EXPORT_HELPER_PATH := "res://../blender/fauna/ferrule/export_ferrule.py"
...
func _run() -> void:
	...
	_verify_wrapper()
	print("FERRULE MODEL: %d checks, %d failures" % [_checks, _failures])
...
func _verify_wrapper() -> void:
	...
	_check(wrapper_text.contains("../blender/fauna/ferrule/ferrule.blend")
		and wrapper_text.contains("../blender/fauna/ferrule/export_ferrule.py"),
