...
const MODEL_PATH := "res://resources/models/fauna/ferrule_v2/ferrule.gltf"
const BIN_PATH := "res://resources/models/fauna/ferrule_v2/ferrule.bin"
const BODY_TEXTURE := "res://resources/models/fauna/ferrule_v2/ferrule_body.png"
const MOUTH_TEXTURE := "res://resources/models/fauna/ferrule_v2/ferrule_mouth.png"
const SIGNAL_TEXTURE := "res://resources/models/fauna/ferrule_v2/ferrule_signal.png"
const SIGNAL_EMISSIVE := "res://resources/models/fauna/ferrule_v2/ferrule_signal_emissive.png"
const WRAPPER_PATH := "res://scenes/props/biota/ferrule_v2_visual.tscn"
const MASTER_PATH := "res://../blender/fauna/ferrule/ferrule_v2.blend"
const EXPORT_HELPER_PATH := "res://../blender/fauna/ferrule/export_ferrule_v2.py"
...
func _run() -> void:
	...
	_verify_wrapper()
	print("FERRULE V2 MODEL: %d checks, %d failures" % [_checks, _failures])
...
func _verify_wrapper() -> void:
	...
	_check(wrapper_text.contains("../blender/fauna/ferrule/ferrule_v2.blend")
		and wrapper_text.contains("../blender/fauna/ferrule/export_ferrule_v2.py"),
	...
	_check(facing_socket != null and impact_socket != null and rear_socket != null
		...
		and rear_socket.position.z < -0.7,
