...
MASTER = "c:/Users/quest/Programming/Games/ToRustAsWeFall/blender/fauna/sapscrap/sapscrap.blend"
OUT_DIR = "c:/Users/quest/Programming/Games/ToRustAsWeFall/to-rust-as-we-fall/resources/models/fauna/sapscrap"
ROOT_NAME = "SapscrapRoot"
REQUIRED_ACTIONS = {"Sapscrap_Idle", "Sapscrap_Windup", "Sapscrap_Lunge", "Sapscrap_Bite"}
...
out_path = os.path.join(OUT_DIR, "sapscrap.gltf")
...
if result["non_opaque"]:
    raise SystemExit("non-opaque materials exported: %s" % result["non_opaque"])
result.update({
