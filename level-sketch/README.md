...
- `kind`: a flora/fauna **species id** (e.g. `seefern`, `flure`, `capbage`, `sapscraps`, `spikers`, `naturalizers` — the full roster + colors live in `scripts/species_catalog.gd`), or `shelter` / `blockin`
